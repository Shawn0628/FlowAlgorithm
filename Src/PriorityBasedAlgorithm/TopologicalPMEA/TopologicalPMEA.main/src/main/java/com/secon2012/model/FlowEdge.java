...
public class FlowEdge implements Comparable<FlowEdge> {
	...
	public RegularNode getV() {
		return v;
	}

	public RegularNode getW() {
		return w;
	}
	...
	public FlowEdge(RegularNode v, RegularNode w, double capacity,
			boolean isEnergyEdge, boolean isTransmisionEdge, double length) {
		if (capacity < 0)
