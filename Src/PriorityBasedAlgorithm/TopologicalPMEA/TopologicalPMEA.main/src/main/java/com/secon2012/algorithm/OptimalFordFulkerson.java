...
public class OptimalFordFulkerson implements Cloneable {
    ...
    public OptimalFordFulkerson(OptimalFlowNetwork G, RegularNode source, RegularNode sink, double receivingEnergy) {
        int s = source.getID();
        int t = sink.getID();
    	value = excess(G, t);
